...
Furthermore, the ability exists to take the currency pair to the <a href="/terminal/guides/intros/common/ta" target="_blank" rel="noreferrer noopener">Technical Analysis</a> menu by typing `ta`.
